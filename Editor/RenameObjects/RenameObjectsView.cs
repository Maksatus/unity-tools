...
namespace Editor.RenameObjects
{
    ...
    {
        private const string StyleSheetPath = "Packages/com.maksatus.unity-tools/Editor/RenameObjects/RenameObjectsView.uss";
        ...
        private static VisualElement CreateEmptyState()
        {
            ...
            var icon = new Image
            {
                image = EditorGUIUtility.IconContent(EmptyIconName).image,
                scaleMode = ScaleMode.ScaleToFit
            };
            icon.AddToClassList("rename-objects__empty-icon");
            container.Add(icon);
