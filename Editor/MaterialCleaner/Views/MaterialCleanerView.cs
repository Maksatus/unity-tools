...
namespace UnityTools.Editor.MaterialCleaner.Views
{
    ...
    {
        private static readonly Dictionary<MaterialSavedPropertyType, string> GroupTitles = new()
        {
            { MaterialSavedPropertyType.Texture, "Textures" },
            { MaterialSavedPropertyType.Int, "Ints" },
            { MaterialSavedPropertyType.Float, "Floats" },
            { MaterialSavedPropertyType.Color, "Colors" }
        };

        private readonly ScrollView _materialList;
        private readonly Label _summaryLabel;

        public event Action<Material, MaterialSavedPropertyType, string> RemovePropertyRequested;
        public event Action<MaterialSavedPropertyType> RemoveUnusedOfTypeRequested;
        ...
        private VisualElement CreatePropertyRow(Material material, MaterialSavedPropertyType type,
