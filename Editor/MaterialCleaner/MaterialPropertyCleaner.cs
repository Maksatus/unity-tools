...
public class MaterialPropertyCleaner : EditorWindow
{
    ...
    private static void Init() => GetWindow<MaterialPropertyCleaner>("Property Cleaner");
    ...
    protected virtual void OnSelectionChange() => GetSelectedMaterials();

    protected virtual void OnProjectChange() => GetSelectedMaterials();
